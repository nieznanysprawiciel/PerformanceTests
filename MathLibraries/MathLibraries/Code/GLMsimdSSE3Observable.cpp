...
class GLMsimdObservalbeSSE3 : public Observable
{
private:
...
public:
	...
	{
		return "GLM SIMD SSE3";
	}
};



int shitVarGLMsimd3 = Framework::Get().AddObservable( new GLMsimdObservalbeSSE3() );
