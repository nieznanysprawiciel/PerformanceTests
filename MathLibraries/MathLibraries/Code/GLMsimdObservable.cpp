...
class GLMsimdObservalbeSSE2 : public Observable
{
private:
...
public:
	...
	{
		return "GLM SIMD SSE2";
	}
};



int shitVarGLMsimd = Framework::Get().AddObservable( new GLMsimdObservalbeSSE2() );
