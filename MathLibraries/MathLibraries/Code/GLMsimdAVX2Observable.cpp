...
class GLMsimdObservalbeAVX2 : public Observable
{
private:
...
public:
	...
	{
		return "GLM SIMD AVX2";
	}
};



int shitVarGLMsimd2 = Framework::Get().AddObservable( new GLMsimdObservalbeAVX2() );
